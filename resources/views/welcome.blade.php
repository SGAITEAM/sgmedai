...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Yapay Zekâ Destekli Çoklu Hastalık Erken Teşhis ve Karar Destek Platformu</title>
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-white-900 sm:items-center py-4 sm:pt-0" style="display: flex; justify-content: flex-start;">
            <div class="hidden fixed top-0 left-0 px-6 py-4 sm:block" style="margin-left: 15%;">
                {{-- <img alt="platform by Emily van den Heever from the Noun Project" title="platform by Emily van den Heever from the Noun Project" src="api-doc/images/logo.png" height="32" style="margin-top:10px; margin-right: 20px; padding-top: 5px;" /> --}}
                <a href="{{ url('/') }}" class="text-sm text-gray-700 dark:text-gray-500 underline"  style="border-bottom: 2px solid #104db4; padding-bottom: 7px; text-decoration: none; color: #104db4; font-size: 1.3em; font-weight:900; margin-right: 1em;">{{ __('auth.home') }}</a>
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0" style="font-size: 2.5em; color: #2d3748; font-weight: 900;">
                    {{-- {{ __('main.title') }} --}}
                    Yapay Zekâ Destekli Çoklu Hastalık Erken Teşhis ve Karar Destek Platformu
                </div>
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    <div class="grid grid-cols-1 md:grid-cols-1">
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            ...
                            <div class="ml-12 pb-3">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm" style="text-align: justify">
                                    Yapay zeka ile cilt hastalıkları ve diyabetik retinopati teşhisi yapmak için tıklayın.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm" style="text-align: justify">
                                    Uzman hekim olarak sistemin veritabanına veri eklemek için tıklayın.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm" style="text-align: justify; padding-right:10px;">
                                    Bu proje <i> sakarya İl Sağlık Müdürlüğü </i> tarafından 
                                    düzenlenen <i>"Sağlıkta İnovasyon"</i> yarışması için geliştirilmiştir.
                                      Evrişimli  sinir ağları ile
                                      açık kaynak veritabanlarında bulunan görüntülerle eğitilmiş yapay zeka
                                      modelleri ile çalışan bir sağlık karar destek uygulamasıdır. Uygulama hakkında daha detaylı bilgi için tıklayın.
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                        Yapay Zekâ Destekli Çoklu Hastalık Karar Destek Sistemi v1.0 (PHP v{{ PHP_VERSION }} & PYTHON v3.9)
                    </div>
                </div>

                <div class="row mt-3" style=" margin-top: 30px; text-align: center;">
                    <div class="col-12" style="color: #4a5568 !important">
