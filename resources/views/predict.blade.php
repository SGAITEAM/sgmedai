    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-white-900 sm:items-center py-4 sm:pt-0" style="display: flex; justify-content: flex-start;">
            <div class="hidden fixed top-0 left-0 px-6 py-4 sm:block" style="margin-left: 15%;">
                ...
                <a href="{{ url('/predict') }}" class="text-sm text-gray-700 dark:text-gray-500 underline"   style="border-bottom: 2px solid #104db4; padding-bottom: 7px; text-decoration: none; color: #104db4; font-size: 1.3em; font-weight:900; margin-right: 1em;">Teşhis</a>
            ...
            <div class="container" style="color: #2d3748; font-size:21px;">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0" style="display: flex; font-family: 'Nunito', sans-serif; font-size: 1.2em; color: #302def; font-weight: 900; justify-content: space-between; flex-direction: row; flex-wrap: wrap;">
                    <span style="color: #2d3748">YZ ile Teşhis için Hastalık Türünü Seçerek Görüntü Yükleyin</span>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-12 mt-3">
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-outline-primary">İncele</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row mt-3" id="res" style="min-height: 10em; display: none;">
                    <div class="col-lg-4 mb-2" id="imageBox">
                        <img src="" class="img-thumbnail" style="min-width: 100%; min-height: 100%;" alt="">
                    </div>
                    <div class="col-lg-8">
        ...
        $('#image-upload').submit(function(e) {
            ...
            $.ajax({
                ...
                success: (datas) => {
                    ...
                    let labels = [];
                    if (diseaseType === "dr") {
                        labels = ["Sağlıklı", "Hafif DR", "Orta DR", "Şiddetli DR", "Proliferatif DR"];
